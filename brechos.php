...
// Busca apenas usuários que são do tipo 'brecho'
$sql = "SELECT * FROM usuarios WHERE tipo = 'brecho' ORDER BY id DESC";
...
<head>
    ...
    <title>ReVeste - Brechós</title>
    <link rel="stylesheet" href="styles/brechos.css" />
    <link rel="shortcut icon" href="images/RV.png"/>
</head>
<body>
    <div class="navbar">
        <div class="header-inner-content">
            <h2 class="navbar-title">Conheça Nossos Brechós</h2>
            <nav>
                <ul>
                    ...
                    <div class="carousel-viewport">
                        <div class="carousel-track">
                            <?php while($row = $result->fetch_assoc()) { 
                                ...
                                // Verifica PERFIL (Se vazio ou se tiver o valor antigo do banco, usa o padrão)
                                $foto_perfil = $row['foto_perfil'];
                                if (empty($foto_perfil) || $foto_perfil == 'images/default-user.png') {
                                    $foto_perfil = $padrao;
                                }

                                // Verifica PROJETOS (Mesma lógica)
            ...
            <?php else: ?>
                <div style="text-align: center; width: 100%; margin-top: 50px;">
                    <p style="font-size: 1.5rem; color: #5C8070; font-weight: bold; font-family: 'Lucida Sans', sans-serif;">
                        Nenhum brechó cadastrado ainda.
                    </p>
                </div>
            <?php endif; ?>
